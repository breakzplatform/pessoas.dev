      ...
      <div>
              ...
              {profile && (
                <>
                  <p className="flex flex-row gap-2 items-center mt-4 text-sm text-muted-forground">
                    <Check className="text-green-500 size-4" /> Conta encontrada
                  </p>
        ...
        >
          <p className="max-w-lg text-sm">
            ...
            digite{" "}
            <strong class="font-mono">{newHandle ? `"${newHandle}"` : "seu novo @"}</strong>. Por
            fim, aperte em <strong>&quot;Verify DNS Record&quot;</strong>.
          </p>
        </Stage>
      </div>
    </main>
